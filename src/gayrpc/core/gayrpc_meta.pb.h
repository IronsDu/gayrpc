...
inline bool RpcMeta_Type_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, RpcMeta_Type* value) {
...
inline bool RpcMeta_DataEncodingType_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, RpcMeta_DataEncodingType* value) {
...
class RpcMeta_Request PROTOBUF_FINAL :
 ...
 public:
  ...
  void UnsafeArenaSwap(RpcMeta_Request* other) {
    if (other == this) return;
  ...
  protected:
  explicit RpcMeta_Request(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
...
class RpcMeta_Response PROTOBUF_FINAL :
 ...
 public:
  ...
  void UnsafeArenaSwap(RpcMeta_Response* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  protected:
  explicit RpcMeta_Response(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
...
public:
  ...
  explicit RpcMeta_MetaDataEntry_DoNotUse(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  ...
  static bool ValidateKey(std::string* s) {
    return ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(s->data(), static_cast<int>(s->size()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::PARSE, "gayrpc.core.RpcMeta.MetaDataEntry.key");
 }
  static bool ValidateValue(std::string* s) {
    return ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(s->data(), static_cast<int>(s->size()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::PARSE, "gayrpc.core.RpcMeta.MetaDataEntry.value");
 }
...
class RpcMeta PROTOBUF_FINAL :
 ...
 public:
  ...
  static inline bool DataEncodingType_Parse(::PROTOBUF_NAMESPACE_ID::ConstStringParam name,
  ...
  void unsafe_arena_set_allocated_request_info(
      ::gayrpc::core::RpcMeta_Request* request_info);
  ::gayrpc::core::RpcMeta_Request* unsafe_arena_release_request_info();
  ...
  void unsafe_arena_set_allocated_response_info(
      ::gayrpc::core::RpcMeta_Response* response_info);
  ::gayrpc::core::RpcMeta_Response* unsafe_arena_release_response_info();
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::MapField<
      ...
      std::string, std::string,
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_STRING,
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_STRING> meta_data_;
...
inline const std::string& RpcMeta_Request::_internal_strmethod() const {
  return strmethod_.Get();
}
inline void RpcMeta_Request::_internal_set_strmethod(const std::string& value) {
  
  strmethod_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
...
inline void RpcMeta_Request::set_strmethod(const char* value) {
  ...
  strmethod_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:gayrpc.core.RpcMeta.Request.strMethod)
}
inline void RpcMeta_Request::set_strmethod(const char* value,
    size_t size) {
  
  strmethod_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
...
inline std::string* RpcMeta_Request::_internal_mutable_strmethod() {
  ...
  return strmethod_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* RpcMeta_Request::release_strmethod() {
  ...
  return strmethod_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void RpcMeta_Request::set_allocated_strmethod(std::string* strmethod) {
  ...
  strmethod_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), strmethod,
      GetArena());
...
inline void RpcMeta::unsafe_arena_set_allocated_request_info(
    ::gayrpc::core::RpcMeta_Request* request_info) {
  if (GetArena() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(request_info_);
  }
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:gayrpc.core.RpcMeta.request_info)
}
...
inline ::gayrpc::core::RpcMeta_Request* RpcMeta::unsafe_arena_release_request_info() {
...
inline ::gayrpc::core::RpcMeta_Request* RpcMeta::_internal_mutable_request_info() {
  ...
  if (request_info_ == nullptr) {
    auto* p = CreateMaybeMessage<::gayrpc::core::RpcMeta_Request>(GetArena());
    request_info_ = p;
  }
...
inline void RpcMeta::set_allocated_request_info(::gayrpc::core::RpcMeta_Request* request_info) {
  ...
  if (request_info) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::GetArena(request_info);
...
inline void RpcMeta::unsafe_arena_set_allocated_response_info(
    ::gayrpc::core::RpcMeta_Response* response_info) {
  if (GetArena() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(response_info_);
  }
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:gayrpc.core.RpcMeta.response_info)
}
...
inline ::gayrpc::core::RpcMeta_Response* RpcMeta::unsafe_arena_release_response_info() {
...
inline ::gayrpc::core::RpcMeta_Response* RpcMeta::_internal_mutable_response_info() {
  ...
  if (response_info_ == nullptr) {
    auto* p = CreateMaybeMessage<::gayrpc::core::RpcMeta_Response>(GetArena());
    response_info_ = p;
  }
...
inline void RpcMeta::set_allocated_response_info(::gayrpc::core::RpcMeta_Response* response_info) {
  ...
  if (response_info) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::GetArena(response_info);
    if (message_arena != submessage_arena) {
