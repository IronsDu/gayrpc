...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_benchmark_5fservice_2eproto = {
  false, false, descriptor_table_protodef_benchmark_5fservice_2eproto, "benchmark_service.proto", 237,
...
static bool dynamic_init_dummy_benchmark_5fservice_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_benchmark_5fservice_2eproto)), true);
namespace dodo {
namespace benchmark {
...
EchoRequest::EchoRequest(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  // @@protoc_insertion_point(arena_constructor:dodo.benchmark.EchoRequest)
}
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "dodo.benchmark.EchoRequest.message"));
          CHK_(ptr);
...
EchoResponse::EchoResponse(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  SharedCtor();
  RegisterArenaDtor(arena);
  // @@protoc_insertion_point(arena_constructor:dodo.benchmark.EchoResponse)
}
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          auto str = _internal_mutable_message();
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "dodo.benchmark.EchoResponse.message"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
template<> PROTOBUF_NOINLINE ::dodo::benchmark::EchoRequest* Arena::CreateMaybeMessage< ::dodo::benchmark::EchoRequest >(Arena* arena) {
  return Arena::CreateMessageInternal< ::dodo::benchmark::EchoRequest >(arena);
}
template<> PROTOBUF_NOINLINE ::dodo::benchmark::EchoResponse* Arena::CreateMaybeMessage< ::dodo::benchmark::EchoResponse >(Arena* arena) {
  return Arena::CreateMessageInternal< ::dodo::benchmark::EchoResponse >(arena);
}
